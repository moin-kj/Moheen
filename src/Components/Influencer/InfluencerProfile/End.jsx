        ...
        <>
            <div className="min-h-screen flex justify-center items-center opacity-transition" data-aos="fade-down">
                <div className="bg-[white] sm:p-2 sml:p-12 rounded-2xl shadow-md w-[500px] ">
                    <img className="img-fluid mx-auto" src="https://media.licdn.com/dms/image/D5612AQHAjuQVVC5-zA/article-cover_image-shrink_600_2000/0/1657725931052?e=2147483647&v=beta&t=YBKZx1PxjDwirN933FwSZMKf1Wyvern9cmdu7i85hDs" alt="" data-aos="fade-up"/>
                    <h4 className="text-center text-blue-600 mb-2 py-2 mt-3">Profile complete! You're ready to stand out!</h4>
