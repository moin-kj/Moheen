        ...
        <>
            <div className="min-h-screen flex justify-center items-center" data-aos="fade-down">
                <div className="bg-[white] sm:p-2 sml:p-12 rounded-2xl shadow-md w-[500px] ">
                    <img className="img-fluid mx-auto" src="https://media.tenor.com/CeDk6XdCgOUAAAAi/develop-web.gif" alt="" data-aos="fade-up" />
                    <h4 className="text-center font-serif text-blue-600 mb-2 py-2 mt-3">Create your profile & explore endless possibilities!
                    </h4>
